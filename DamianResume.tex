  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubProjheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Enhanced the WebAssembly compiler~(wabtaot) by presenting a lightweight code storage alternative to store its AOT data.}
        \resumeItem{Performed analysis on the shared cache and the ELF shared object code containers with metrics like execution like exection speed, memory footprint, I/O utilization, file size, code sharing and concurrency.}
      \resumeItemListEnd
